Ext.define('Ux.locale.Manager', {
    ...
    loadAjaxRequest: function(callback) {
        ...
        var ajaxConfig = Ext.apply({}, me._ajaxConfig),
            ...
            json;
		//console.log("loadAjaxRequest:" + language);
		...
		Ext.apply(ajaxConfig, {
            ...
            callback : function(options, success, response) {
                ...
                me._locale = json;
                me._loaded = true;
				console.log("loadAjaxRequest DONE:" + language);
                if (typeof callback == 'function') {
    ...
    applyLocales : function() {
    	var cmps     = Ext.ComponentQuery.query('component[localize]'),
            c        = 0,
            cNum     = cmps.length,
	...
	applyLocaleForCmp : function(cmp) {
		if (!this.isLoaded()) {
            return;
        }
    ...
    get : function(key, defaultText) {
        ...
        if (!me.isLoaded()) {
            return 'LOCALE LANG DID NOT LOAD';//defaultText;
        }
