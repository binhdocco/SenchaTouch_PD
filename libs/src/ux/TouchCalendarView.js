...
Ext.define('Ext.ux.TouchCalendarView', {
    ...
    /**
   	...
   	commonTemplateFunctions: {
   		...
   		getHeaderClass: function(currentIndex){
   			//return currentIndex === 5 ? this.me.getPrevPeriodCls(): currentIndex === 6 ? this.me.getNextPeriodCls() : currentIndex === 7 ? this.me.getAddPeriodCls() : '';
			return currentIndex === 6 ? this.me.getPrevPeriodCls(): currentIndex === 7 ? this.me.getNextPeriodCls() : '';
   		}
   	},
	...
	onTableHeaderTap: function(e, el){
		...
		}else if(el.hasCls(this.getAddPeriodCls())){
			 this.fireEvent('add', this, null, null);
		}
	},
